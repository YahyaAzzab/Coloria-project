...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Coloria — Livres de coloriage premium" },
      { name: "description", content: "Livres de coloriage thématiques et packs créatifs premium pour enfants, ados et adultes. Détente, créativité et anti-stress." },
      { name: "author", content: "Coloria" },
      { property: "og:title", content: "Coloria — Livres de coloriage premium" },
      { property: "og:description", content: "Livres de coloriage thématiques et packs créatifs premium pour enfants, ados et adultes. Détente, créativité et anti-stress." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Coloria — Livres de coloriage premium" },
      { name: "twitter:description", content: "Livres de coloriage thématiques et packs créatifs premium pour enfants, ados et adultes. Détente, créativité et anti-stress." },
